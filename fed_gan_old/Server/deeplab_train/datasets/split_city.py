...
data_root = '/home/ilab/gxy/images/global_city/images'
save_file = '/home/ilab/gxy/images/global_city/train_val'
...
for i,file_name in enumerate(file_names):
    ...
    if file_name.endswith('_labels.png'):
        ...
        if index > file_len/2*0.2 and flag == 0:
            ...
            path = os.path.join(save_file, 'train_' + str(train_index))
            data_root = '/home/ilab/gxy/AsynDGAN-master/results/example/train_latest/images'


        if flag == 0:
            img_name = file_name.split('_')[0]

            img_name = str(img_name) + '_image.png'
            ...
            img_name = file_name.split('_')[0]
            img_read_name = img_name+"_labels_fake_B.png"
            img_name_1 = img_name
            img_name = str(img_name) + '_image.png'
            ...
            mask = Image.open(os.path.join('/home/ilab/gxy/images/global_city/images', file_name))
            mask.save(mask_path)
t2 = time.time()
print(t2-t1)
