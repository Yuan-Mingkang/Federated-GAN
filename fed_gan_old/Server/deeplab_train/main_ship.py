...
def get_dataset(opts):
    ...
    train_dst = ShipSegmentation(root=opts.data_root,image_set='images', transform=train_transform)
    val_dst = ShipSegmentation(root=opts.data_root,image_set='val', transform=val_transform)
    ...
    while True:  # cur_itrs < opts.total_itrs:
        ...
        for (images, labels) in train_loader:
            ...
            if (cur_itrs) % opts.val_interval == 0:
                save_ckpt('../checkpoints/deeplab/latest_%s_%s_os%d.pth' %
                ...
                if val_score['Mean IoU'] > best_score:  # save best model
                    ...
                    save_ckpt('../checkpoints/deeplab/best_%s_%s_os%d.pth' %
                              (opts.model, opts.dataset, opts.output_stride))
                model.train()
            scheduler.step()
