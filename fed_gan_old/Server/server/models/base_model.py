...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        if opt.preprocess != 'scale_width':  # with [scale_width], input images1 might have different sizes, which hurts the performance of cudnn.benchmark.
    ...
    def eval(self):
        """Make models eval mode during val time"""
    ...
    def compute_visuals(self):
        """Calculate additional output images1 for visdom and HTML visualization"""
        pass
    ...
    def get_current_visuals(self):
        """Return visualization images1. images.py will display these images1 with visdom, and save the images1 to a HTML"""
    ...
    def get_current_losses(self):
        """Return traning losses / errors. images.py will print out these errors on console, and save them to a file"""
