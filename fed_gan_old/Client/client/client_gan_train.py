...
if __name__ == '__main__':
    ...
    if opt.mask_path == 'None':
        sg.popup_auto_close("Please enter mask_path and start again!", title='提示', button_type=5, font='Any 18')
    try:
        client = Client(server_ip, port)
        client.start()
    except Exception as e:
        sg.popup_auto_close("Please click the [StartTrain] button on the server side first and start again!", title='提示', button_type=5, font='Any 18')
    ...
    # 根据epoch更新
    # 还需要将绝对路径注释掉，
    # 用于可视化部分的loss已经在discriminator_epoch_model.py
    # 加入了两个提示框
    if opt.Update_Frequency > 0:
        ...
        sg.popup_auto_close("Sending data finished, start training!", title='提示', button_type=5, font='Any 18')
        ...
        sg.popup_auto_close("Training completed!", title='提示', button_type=5, font='Any 18')
