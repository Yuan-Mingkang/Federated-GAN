...
while True:
    ...
    if event == 'CONNECTSERVER':
        ...
        try:
            ...
            error = e
            sg.popup_auto_close('Server turned on!', title='提示', button_type=5, font='Any 18')
        else:
    ...
    # gan test
    # fakepath = '../data/fakeimg'
    # fakeimglist = os.listdir(fakepath)
    # if fakeimglist:
    #     sample = random.sample(fakeimglist, 1)
    #     window["-IMAGE1-"].update(convert_to_bytes(sample, PIC_SIZE))
