# import network
# import utils
from deeplab_test import network
from deeplab_test import utils
import os
import argparse
import numpy as np
from deeplab_test.datasets import ShipSegmentation
...
class Predict():
    def __init__(self):
        ...
        self.opts.ckpt = "../checkpoints/deeplab/best_deeplabv3plus_resnet101_ship_os16.pth"
    ...
    def get_argparser(self):
        ...
        return parser
    # 加入保存文件的代码
    def start(self,save_path,img_path, img_name):
        print("start")
        ...
        with torch.no_grad():
            ...
            # pred_save.show()
            pred_save.save(os.path.join(save_path))
