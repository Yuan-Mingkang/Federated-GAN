...
class CityDataset(BaseDataset):
    ...
    def __init__(self, opt, idx=None):
        ...
        real_dir = opt.real_path
        mask_dir = opt.mask_path
        ...
        for file_name in mask_names:
            mask_name = os.path.join(mask_dir, file_name)
            self.masks.append(mask_name)    #'xxx.png' is mask
            file_name = file_name.split('.')[0]
        for file_name in real_names:
            img_name = os.path.join(real_dir, file_name)
        ...
        #         file_name = file_name.split('.')[0]
        #
        #         file_name = str(file_name) + '.png' #'xxx.jpg'is real image
    ...
    def __getitem__(self, idx):
        ...
        #     mask = Image.open(A_path)
            # mask.save('/home/ilab/wenrou_lee/0.png')
