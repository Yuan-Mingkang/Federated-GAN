...
class DiscriminatorModel(BaseModel):
    ...
    def backward_D(self):
        ...
        # 2022.8.23加入保存loss代码,以","区分数据，以便画图
    ...
    def optimize_parameters(self, client,dataset_real, batchsize):
        ...
        for h in range(batchsize):
            fake_path = "../data/fakeimg"
            fake_path1 = fake_path + f'/{indexs[h]}.jpg'
            utils.save_image(self.fake_B[h], fake_path1, normalizer=True)
        l_A = []
        l_B = []
